  ...
  return (
    <Container>
      ...
      <VStack color={secondaryText} spacing={3} alignItems="flex-start" lineHeight="tall">
        <Text>
          Saya sangat tertarik dengan dunia seputar pemrograman dan akutansi. Saat ini sedang
        ...
        <Text>
          ...
          <Link href="/contact">menyapa saya</Link> khususnya melalui WhatsApp, karena saya senang
